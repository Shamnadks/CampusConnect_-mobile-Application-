...
public class view_notes extends AppCompatActivity {
    ...
    String[] note_id,subject_id,note,date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = sh.getString("url","")+"and_view_notes";
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                for (int i = 0; i < js.length(); i++) {
                                    ...
                                    note_id[i] = u.getString("note_id");//dbcolumn name in double quotes
                                    subject_id[i] = u.getString("subject");
                                ...
                                li.setAdapter(new custom_view_notes(getApplicationContext(), note_id, date, note,subject_id) {
