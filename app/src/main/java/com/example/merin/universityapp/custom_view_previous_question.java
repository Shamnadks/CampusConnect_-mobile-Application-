...
public class custom_view_previous_question extends BaseAdapter {

    String[] question, year;

    private final Context context;

    public custom_view_previous_question(Context applicationContext, String[] question, String[] year) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            gridView = inflator.inflate(R.layout.activity_custom_view_previous_question, null);//same class name
